...
if __name__ == '__main__':
    ...
    # Initialize motors
    m1_motor = cast(Motor, robot.getDevice("m1_motor"))
    m1_motor.setPosition(float('inf'))
    m1_motor.setVelocity(-1)
    m2_motor = cast(Motor, robot.getDevice("m2_motor"))
    m2_motor.setPosition(float('inf'))
    m2_motor.setVelocity(1)
    m3_motor = cast(Motor, robot.getDevice("m3_motor"))
    m3_motor.setPosition(float('inf'))
    m3_motor.setVelocity(-1)
    m4_motor = cast(Motor, robot.getDevice("m4_motor"))
    m4_motor.setPosition(float('inf'))
    m4_motor.setVelocity(1)

    # Initialize Sensors
    imu = cast(InertialUnit, robot.getDevice("inertial_unit"))
    imu.enable(timestep)
    ...
    range_front = cast(DistanceSensor, robot.getDevice("range_front"))
    range_front.enable(timestep)
    range_left = cast(DistanceSensor, robot.getDevice("range_left"))
    range_left.enable(timestep)
    range_back = cast(DistanceSensor, robot.getDevice("range_back"))
